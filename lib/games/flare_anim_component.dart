...
class FlareBobGame extends BaseGame with TapDetector, DoubleTapDetector {
  ...
  void _start() async {
    flareComponent = FlareComponent('assets/images/flare/Bob_Minion.flr', 'Stand', 306, 228);
    flareComponent.x = 50;
  ...
  void render(Canvas canvas) {
    ...
    if (debugMode()) {
      fpsTextConfig.render(canvas, fps(120).toString(), Position(10, 100));
    }
  }
}